...
Plugin URI: http://rxa.li/mymail?utm_campaign=wporg&utm_source=Contact+Form+7+for+MyMail
	...
	public function editor_panel( $post ) {
		...
		if ( ! function_exists( 'mymail' ) ) {
			...
			if ( isset( $all_plugins['myMail/myMail.php'] ) ) {
				...
				echo '<div class="error inline"><p>You need the <a href="http://rxa.li/mymail?utm_campaign=wporg&utm_source=Contact+Form+7+for+MyMail+Newsletter">MyMail Newsletter Plugin for WordPress</a> to use your Form with MyMail</p></div>';
